...
const REGULATORY_SCENARIOS: RegulatoryScenario[] = [
  ...
  },
  {
    ...
    framework: "LGPD",
    badge: "Brazil (ANPD)",
    version: "Resolution CD/ANPD No. 18/2026",
    title: "LGPD Art. 16 — Biometric Data Processing Termination",
    changeSummary: "Mandatory deadline for definitive disposal of biometric and sensitive data set to 90 days after contract termination.",
    affectedClause: "§ 4.2 Data Processing Termination & Erasure",
    currentClauseText: "Employee and contractor registration data and biometric records shall be stored indefinitely for historical and physical security purposes.",
    remediatedClauseText: "Employee and contractor registration data and biometric records shall be definitively disposed of within a non-extendable period of up to 90 (ninety) days after contract termination, pursuant to LGPD Art. 16 and ANPD Resolution 18/2026.",
    legalAnalysis: "Indefinite storage of biometric data is considered a high-risk practice and a direct violation of the necessity principle (Art. 6, III) and processing termination requirements (Art. 16).",
  ...
  },
  {
    ...
    title: "Control A.8.10 — Mandatory Cryptographic Disposal",
    changeSummary: "Encryption and sanitization at rest required for storage media with auditable disposal logs.",
    affectedClause: "§ 5.1 Media Disposal & Sanitization",
    currentClauseText: "Decommissioned storage media and backups shall be physically disposed of at the internal IT team's convenience.",
    remediatedClauseText: "Decommissioned storage media and cloud volumes shall undergo cryptographic erasure with discarded keys and sanitization certification per ISO/IEC 27001:2025 Control A.8.10.",
    legalAnalysis: "The non-standardized physical disposal procedure does not meet the new stringent data sanitization controls for multi-tenant environments.",
